...
UMPhysicsList::UMPhysicsList():  G4VUserPhysicsList()
{
	...
	defaultCutValue = 1.*um; 	//new
	
	cutForGamma   = defaultCutValue ;        //new
	cutForElectron  = defaultCutValue ;        //new
	cutForPositron  = defaultCutValue ;        //new
	
	SetVerboseLevel(1);

	// EM physics
	emPhysicsList = new G4EmPenelopePhysics();    //new
